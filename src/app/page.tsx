...
export default function Home(): JSX.Element {
  ...
  const divCard =
    "p-3 rounded-lg text-white border border-white bg-l_white flex flex-col w-80";
  ...
  return (
    <>
      ...
      >
        ...
        <h1  data-aos="fade-down" className="font-black mb-12 text-black border-0 text-4xl md:text-7xl">
          DESIGN YOUR PERFECT <br />
          RESUME IN
          <span className="headingdiv">
            <span
              style={{ fontFamily: "Dancing Script" }}
              className="text text-purple_col"
            >
              MINUTES
            </span>
          </span>
          ...
          <div  data-aos="fade-left" className="flex items-end">
            <div>
              <p className="mx-auto text-gray-600">
                Craft a standout resume tailored to your career needs. Our
                user-friendly platform makes it quick, easy, and free to
                showcase your skills and experiences. Craft a standout resume
                tailored to your career needs. Our user-friendly platform makes
                it quick, easy, and free to showcase your skills and
                experiences.
              </p>

              <Link href="/build-your-resume">
                <button className={`mt-5 ${btn_classes} `}>
                  Get Started Now
                </button>
              </Link>
            </div>
      ...
      >
        <div className="mx-auto w-5/6">
          <h1  data-aos="fade-right" className="font-extrabold mb-8 text-white text-black border-0  text-4xl md:text-6xl">
            FEATURES OF <br />
            OUR WEBSITE
          </h1>

          <p  data-aos="fade-right" className="text-gray-300 mb-5">
            Easily create resumes with customizable templates, color themes, and
            free PDF downloads, all while keeping your information secure.
          </p>
            ...
            {CardContent.map((crntEle) => {
              return (
                <div  data-aos="fade-up"
                  key={crntEle.id}
                  className={`${divCard}  inset-0 backdrop-blur-lg bg-white/30`}
                >
